...
output_file = r'./data/raw/pleiades-places-latest.json'

# Download the compressed JSON file
urllib.request.urlretrieve(url, r'./data/raw/pleiades-places-latest.json.gz')

# Decompress the file and save the JSON data
with gzip.open(r'./data/raw/pleiades-places-latest.json.gz', 'rb') as f_in:
